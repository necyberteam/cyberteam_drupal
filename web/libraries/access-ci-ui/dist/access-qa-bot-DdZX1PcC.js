import { l as le, _ as ne, b as oe, k as ft, H as et, h as K, g as Go, p as qo, y as ee, a as An, A as ie, F as or, T as ke, q as G, x as He, P as Wo, G as Ye, m as ka, B as Jt, D as Pa, E as Ba, u as E } from "./index-Cw9mKXHY.js";
...
}, useCallback: G, useContext: He, useDebugValue: Wo, useDeferredValue: ti, useEffect: ee, useId: Go, useImperativeHandle: or, useInsertionEffect: ri, useLayoutEffect: An, useMemo: ke, useReducer: qo, useRef: ie, useState: K, useSyncExternalStore: oi, useTransition: ni } } };
function eA(e) {
...
var O = { useState: K, useId: Go, useReducer: qo, useEffect: ee, useLayoutEffect: An, useInsertionEffect: ri, useTransition: ni, useDeferredValue: ti, useSyncExternalStore: oi, startTransition: ei, useRef: ie, useImperativeHandle: or, useMemo: ke, useCallback: G, useContext: He, useDebugValue: Wo, version: "18.3.1", Children: Ra, render: Jo, hydrate: Zo, unmountComponentAtNode: $o, createPortal: ja, createElement: ne, createContext: Ye, createFactory: eA, cloneElement: rA, createRef: ka, Fragment: oe, isValidElement: ht, isElement: sA, isFragment: tA, isMemo: nA, findDOMNode: oA, Component: ft, PureComponent: zn, memo: La, forwardRef: Me, flushSync: aA, unstable_batchedUpdates: iA, StrictMode: AA, Suspense: qt, SuspenseList: It, lazy: Fa, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: $a };
function ii(e) {
  return {
...
}, ui = Ye({}), me = () => He(ui), EA = ({ children: e, botIdRef: t, flowRef: n }) => {
...
}, di = Ye({}), ye = () => He(di), kA = ({ children: e, settings: t }) => {
  var n, r, o, i, a, s;
...
const PA = { [U.START_SPEAK_AUDIO]: !0, [U.TOGGLE_AUDIO]: !0, [U.TOGGLE_VOICE]: !0, [U.TOGGLE_NOTIFICATIONS]: !0, [U.TOGGLE_CHAT_WINDOW]: !0, [U.PRE_INJECT_MESSAGE]: !0, [U.POST_INJECT_MESSAGE]: !1, [U.PRE_LOAD_CHATBOT]: !0, [U.POST_LOAD_CHATBOT]: !1, [U.START_SIMULATE_STREAM_MESSAGE]: !0, [U.STOP_SIMULATE_STREAM_MESSAGE]: !1, [U.START_STREAM_MESSAGE]: !0, [U.CHUNK_STREAM_MESSAGE]: !0, [U.STOP_STREAM_MESSAGE]: !0, [U.REMOVE_MESSAGE]: !0, [U.LOAD_CHAT_HISTORY]: !0, [U.CHANGE_PATH]: !0, [U.SHOW_TOAST]: !0, [U.DISMISS_TOAST]: !0, [U.USER_SUBMIT_TEXT]: !0, [U.USER_UPLOAD_FILE]: !0, [U.TEXT_AREA_CHANGE_VALUE]: !0, [U.PRE_PROCESS_BLOCK]: !0, [U.POST_PROCESS_BLOCK]: !0 }, jn = async (e, t, n) => {
  ...
  var l;
}, fi = Ye({ messages: [], setSyncedMessages: () => {
...
let nt, mi = !1, en = "rcb-history", Wt = 30, yi = !1, Lt = [];
const fn = async (e) => {
  if (yi || !nt) return;
  ...
  var t, n, r, o, i;
  nt = ((n = (t = e.chatHistory) == null ? void 0 : t.storageType) == null ? void 0 : n.toUpperCase()) === "SESSION_STORAGE" ? sessionStorage : localStorage, en = (r = e.chatHistory) == null ? void 0 : r.storageKey, Wt = (o = e.chatHistory) == null ? void 0 : o.maxEntries, yi = (i = e.chatHistory) == null ? void 0 : i.disabled, Lt = ((a) => {
    if (a != null) try {
      return JSON.parse(a);
    } catch {
      return [];
  ...
  return Array.from(r.body.childNodes).map((o, i) => {
    ...
    if (o.nodeType === Node.TEXT_NODE) return o.textContent;
    {
      ...
      if (Object.prototype.hasOwnProperty.call(A, "class")) {
        const d = o.classList;
        A.className = d.toString(), delete A.class, (a = t.botBubble) != null && a.showAvatar && (A = WA(d, A)), A = YA(d, A, t, n), A = VA(d, A, t, n), A = XA(d, A, t, n), A = KA(d, A, t, n);
      }
...
}, WA = (e, t) => ((e.contains("rcb-options-container") || e.contains("rcb-checkbox-container")) && (t.className = `${e.toString()} rcb-options-offset`), t), YA = (e, t, n, r) => {
  var o, i, a, s, A;
...
const cr = () => {
  ...
  d.onresult = (l) => {
    ...
    u && (Ue = setTimeout(async () => await gn(t, i), u)), (p = e.voice) != null && p.autoSendDisabled || (Yt = setTimeout(n, c));
  }, d.onend = () => {
    tt ? (d.start(), !Ue && u && (Ue = setTimeout(async () => await gn(t, i), u))) : (clearTimeout(Ue), Ue = null, clearTimeout(Yt));
  ...
  const e = cr();
  e && (tt = !1, e && e.stop(), qe && qe.state !== "inactive" && (qe.stop(), qe = null), clearTimeout(Ue), Ue = null, clearTimeout(Yt));
}, gn = async (e, t) => {
  var n;
...
}, ys = "https://cdn.jsdelivr.net/gh/react-chatbotify/community-themes/themes", vs = "2592000", Wr = "RCB_THEME_CACHE_DATA", Yr = async (e, t) => {
...
}, Gs = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u, qs = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u, Ws = {};
function $r(e, t) {
  return (Ws.jsx ? qs : Gs).test(e);
}
const Ys = /[ \t\n\f\r]/g;
function eo(e) {
  return e.replace(Ys, "") === "";
...
function vt(e) {
  ...
  for (r in e.properties) if (Xs.call(e.properties, r)) {
    ...
    e.mustUseProperty && e.mustUseProperty.includes(r) && (i.mustUseProperty = !0), t[r] = i, n[Yn(r)] = r, n[Yn(i.attribute)] = r;
  }
...
const gr = {}.hasOwnProperty, al = /* @__PURE__ */ new Map(), Al = /[A-Z]/g, sl = /-([a-z])/g, ll = /* @__PURE__ */ new Set(["table", "tbody", "thead", "tfoot", "tr"]), cl = /* @__PURE__ */ new Set(["td", "th"]), Wi = "https://github.com/syntax-tree/hast-util-to-jsx-runtime";
function ul(e, t) {
      ...
      let o = typeof n == "object" ? n : function(i, a) {
        ...
        try {
          ...
          if (!i.ignoreInvalidStyle) {
            ...
            throw c.file = i.filePath || void 0, c.url = Wi + "#cannot-parse-style-attribute", c;
          }
        }
        return s;
        function A(d, u) {
...
const Pl = { tokenize: function(e) {
  ...
  function o(i) {
    return i === null ? (e.exit("chunkText"), e.exit("paragraph"), void e.consume(i)) : Y(i) ? (e.consume(i), e.exit("chunkText"), r) : (e.consume(i), o);
  }
...
const Dl = { name: "autolink", tokenize: function(e, t, n) {
  ...
  const r = this, o = { partial: !0, tokenize: function(m, x, k) {
    ...
    function Q(D) {
      return D === null || Y(D) ? (m.exit("codeFencedFence"), x(D)) : k(D);
    }
  } };
  let i, a = 0, s = 0;
  return function(m) {
  ...
  function d(m) {
    return m === null || Y(m) ? (e.exit("codeFencedFence"), r.interrupt ? t(m) : e.check(mo, f, w)(m)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", { contentType: "string" }), u(m));
  }
  function u(m) {
    return m === null || Y(m) ? (e.exit("chunkString"), e.exit("codeFencedFenceInfo"), d(m)) : re(m) ? (e.exit("chunkString"), e.exit("codeFencedFenceInfo"), ue(e, c, "whitespace")(m)) : m === 96 && m === i ? n(m) : (e.consume(m), u);
  }
  function c(m) {
    return m === null || Y(m) ? d(m) : (e.enter("codeFencedFenceMeta"), e.enter("chunkString", { contentType: "string" }), l(m));
  }
  function l(m) {
    return m === null || Y(m) ? (e.exit("chunkString"), e.exit("codeFencedFenceMeta"), d(m)) : m === 96 && m === i ? n(m) : (e.consume(m), l);
  }
  function f(m) {
  ...
  function g(m) {
    return m === null || Y(m) ? e.check(mo, f, w)(m) : (e.enter("codeFlowValue"), v(m));
  }
  function v(m) {
  ...
  function i(A) {
    return A === null ? s(A) : Y(A) ? e.attempt(Cl, i, s)(A) : (e.enter("codeFlowValue"), a(A));
  }
  function a(A) {
    return A === null || Y(A) ? (e.exit("codeFlowValue"), i(A)) : (e.consume(A), a);
  }
  function s(A) {
  ...
  return o;
  function o(a) {
    return r.parser.lazy[r.now().line] ? n(a) : Y(a) ? (e.enter("lineEnding"), e.consume(a), e.exit("lineEnding"), o) : ue(e, i, "linePrefix", 5)(a);
  }
  function i(a) {
    const s = r.events[r.events.length - 1];
    return s && s[1].type === "linePrefix" && s[2].sliceSerialize(s[1], !0).length >= 4 ? t(a) : Y(a) ? o(a) : n(a);
  }
  ...
  function s(u) {
    return u === null ? n(u) : u === 32 ? (e.enter("space"), e.consume(u), e.exit("space"), s) : u === 96 ? (o = e.enter("codeTextSequence"), r = 0, d(u)) : Y(u) ? (e.enter("lineEnding"), e.consume(u), e.exit("lineEnding"), s) : (e.enter("codeTextData"), A(u));
  }
  function A(u) {
    return u === null || u === 32 || u === 96 || Y(u) ? (e.exit("codeTextData"), s(u)) : (e.consume(u), A);
  }
  function d(u) {
...
const Ql = { resolve: function(e) {
  ...
  function r(a) {
    return a === null ? o(a) : Y(a) ? e.check(_l, i, o)(a) : (e.consume(a), r);
  }
  function o(a) {
...
function ea(e, t, n, r, o, i, a, s, A) {
  ...
  function l(g) {
    return g === 62 ? (e.exit("chunkString"), e.exit(s), c(g)) : g === null || g === 60 || Y(g) ? n(g) : (e.consume(g), g === 92 ? f : l);
  }
  function f(g) {
...
function ta(e, t, n, r, o, i) {
  ...
  function d(l) {
    return A > 999 || l === null || l === 91 || l === 93 && !s || l === 94 && !A && "_hiddenFootnoteSupport" in a.parser.constructs ? n(l) : l === 93 ? (e.exit(i), e.enter(o), e.consume(l), e.exit(o), e.exit(r), t) : Y(l) ? (e.enter("lineEnding"), e.consume(l), e.exit("lineEnding"), d) : (e.enter("chunkString", { contentType: "string" }), u(l));
  }
  function u(l) {
    return l === null || l === 91 || l === 93 || Y(l) || A++ > 999 ? (e.exit("chunkString"), d(l)) : (e.consume(l), s || (s = !re(l)), l === 92 ? c : u);
  }
  function c(l) {
...
function na(e, t, n, r, o, i) {
  ...
  function A(c) {
    return c === a ? (e.exit(i), s(a)) : c === null ? n(c) : Y(c) ? (e.enter("lineEnding"), e.consume(c), e.exit("lineEnding"), ue(e, A, "linePrefix")) : (e.enter("chunkString", { contentType: "string" }), d(c));
  }
  function d(c) {
    return c === a || c === null || Y(c) ? (e.exit("chunkString"), A(c)) : (e.consume(c), c === 92 ? u : d);
  }
  function u(c) {
...
function Mt(e, t) {
  let n;
  return function r(o) {
    return Y(o) ? (e.enter("lineEnding"), e.consume(o), e.exit("lineEnding"), n = !0, r) : re(o) ? ue(e, r, n ? "linePrefix" : "lineSuffix")(o) : t(o);
  };
}
const Ml = { name: "definition", tokenize: function(e, t, n) {
  ...
  function u(c) {
    return c === null || Y(c) ? (e.exit("definition"), r.parser.defined.push(o), t(c)) : n(c);
  }
  ...
  function i(A) {
    return A === 35 ? (e.enter("atxHeadingSequence"), a(A)) : A === null || Y(A) ? (e.exit("atxHeading"), t(A)) : re(A) ? ue(e, i, "whitespace")(A) : (e.enter("atxHeadingText"), s(A));
  }
  function a(A) {
  ...
  function B(b) {
    return b === 45 && o === 2 ? (e.consume(b), R) : b === 60 && o === 1 ? (e.consume(b), H) : b === 62 && o === 4 ? (e.consume(b), y) : b === 63 && o === 3 ? (e.consume(b), L) : b === 93 && o === 5 ? (e.consume(b), F) : !Y(b) || o !== 6 && o !== 7 ? b === null || Y(b) ? (e.exit("htmlFlowData"), Q(b)) : (e.consume(b), B) : (e.exit("htmlFlowData"), e.check(Fl, z, Q)(b));
  }
  function Q(b) {
  ...
  const r = this;
  return function(i) {
    return Y(i) ? (e.enter("lineEnding"), e.consume(i), e.exit("lineEnding"), o) : n(i);
  };
  function o(i) {
    return r.parser.lazy[r.now().line] ? n(i) : t(i);
  }
  ...
  function u(y) {
    return y === null ? n(y) : y === 45 ? (e.consume(y), c) : Y(y) ? (a = u, N(y)) : (e.consume(y), u);
  }
  function c(y) {
  ...
  function p(y) {
    return y === null ? n(y) : y === 93 ? (e.consume(y), h) : Y(y) ? (a = p, N(y)) : (e.consume(y), p);
  }
  function h(y) {
  ...
  function v(y) {
    return y === null || y === 62 ? H(y) : Y(y) ? (a = v, N(y)) : (e.consume(y), v);
  }
  function w(y) {
    return y === null ? n(y) : y === 63 ? (e.consume(y), m) : Y(y) ? (a = w, N(y)) : (e.consume(y), w);
  }
  function m(y) {
    return y === 62 ? H(y) : w(y);
  }
  ...
  function P(y) {
    return Y(y) ? (a = P, N(y)) : re(y) ? (e.consume(y), P) : H(y);
  }
  function S(y) {
    return y === 45 || Se(y) ? (e.consume(y), S) : y === 47 || y === 62 || Be(y) ? T(y) : n(y);
  }
  function T(y) {
    return y === 47 ? (e.consume(y), H) : y === 58 || y === 95 || Ge(y) ? (e.consume(y), C) : Y(y) ? (a = T, N(y)) : re(y) ? (e.consume(y), T) : H(y);
  }
  function C(y) {
    return y === 45 || y === 46 || y === 58 || y === 95 || Se(y) ? (e.consume(y), C) : B(y);
  }
  function B(y) {
    return y === 61 ? (e.consume(y), Q) : Y(y) ? (a = B, N(y)) : re(y) ? (e.consume(y), B) : T(y);
  }
  function Q(y) {
    return y === null || y === 60 || y === 61 || y === 62 || y === 96 ? n(y) : y === 34 || y === 39 ? (e.consume(y), o = y, D) : Y(y) ? (a = Q, N(y)) : re(y) ? (e.consume(y), Q) : (e.consume(y), _);
  }
  function D(y) {
    return y === o ? (e.consume(y), o = void 0, R) : y === null ? n(y) : Y(y) ? (a = D, N(y)) : (e.consume(y), D);
  }
  function _(y) {
  ...
  return i = [["enter", A, t], ["enter", d, t]], i = Qe(i, e.slice(r + 1, r + s + 3)), i = Qe(i, [["enter", u, t]]), i = Qe(i, yr(t.parser.constructs.insideSpan.null, e.slice(r + s + 4, o - 3), t)), i = Qe(i, [["exit", u, t], e[o - 2], e[o - 1], ["exit", d, t]]), i = Qe(i, e.slice(o + 1)), i = Qe(i, [["exit", A, t]]), We(e, r, e.length, i), e;
}, tokenize: function(e, t, n) {
  const r = this;
...
} }, Wl = { name: "labelStartImage", resolveAll: vr.resolveAll, tokenize: function(e, t, n) {
  const r = this;
  return function(a) {
...
} }, Yl = { name: "labelStartLink", resolveAll: vr.resolveAll, tokenize: function(e, t, n) {
  const r = this;
  return function(i) {
  ...
  function i(s) {
    return s === r ? (e.enter("thematicBreakSequence"), a(s)) : o >= 3 && (s === null || Y(s)) ? (e.exit("thematicBreak"), t(s)) : n(s);
  }
  function a(s) {
...
Would you like to submit a help ticket for ACCESS login issues?`, options: ["Yes, let's create a ticket", "Back to Main Menu"], chatDisabled: !0, path: (c) => c.userInput === "Yes, let's create a ticket" ? "access_login_description" : "start" }, access_login_description: { message: "Describe your login issue.", function: (c) => {
      const l = W(), f = { ...l, description: c.userInput, email: A.email || l.email, name: A.name || l.name, accessId: A.username || l.accessId };
      s(f);
      ...
      const l = W(), f = ge(A), p = Nn(l.uploadedFiles);
      let h = f.accessId;
...
Would you like to submit this ticket?`;
      ...
      if (c.userInput === "Submit Ticket") {
        const l = W(), f = ge(A), p = { email: f.email || "", userName: f.name || "", accessId: f.accessId || "", description: l.description || "", identityProvider: l.identityProvider || "", browser: l.browser || "" };
...
Would you like to submit this ticket?`;
      ...
      if (c.userInput === "Submit Ticket") {
        const l = W(), f = ge(A), p = { email: f.email || "", userName: f.name || "", accessId: f.accessId || "", accessResource: l.resource || "", description: l.description || "", userIdAtResource: l.userIdResource || "" };
    ...
    return { general_help_summary_subject: { message: "Provide a short title for your ticket.", function: (c) => {
      const l = W(), f = { ...l, summary: c.userInput, email: A.email || l.email, name: A.name || l.name, accessId: A.username || l.accessId };
      s(f);
      ...
      const l = W(), f = l.keywords || [], p = c.userInput, h = Array.isArray(f) ? [...f] : f.split(",").map((w) => w.trim()), g = h.filter((w) => w !== "I don't see a relevant keyword"), v = Array.isArray(g) && g.length > 0 ? [...g, p].join(", ") : p;
...
Would you like to submit this ticket?`;
      ...
      if (c.userInput === "Submit Ticket") {
        const l = W(), f = ge(A), p = { email: f.email || "", summary: l.summary || "General Support Ticket", description: l.description || "", priority: l.priority || "medium", accessId: f.accessId || "", userName: f.name || "", issueType: l.category || "", hasResourceProblem: l.involvesResource === "yes" ? "Yes" : "No", userIdAtResource: l.userIdAtResource || "", resourceName: l.resourceDetails || "", keywords: l.keywords || "", noRelevantKeyword: l.suggestedKeyword ? "checked" : "", suggestedKeyword: l.suggestedKeyword || "" };
  ...
  return { security_incident: { message: "You're reporting a security incident. Please provide a brief summary of the security concern.", function: (i) => {
    const a = W() || {}, s = { ...a, summary: i.userInput, email: n.email || a.email, name: n.name || a.name, accessId: n.username || a.accessId };
    t(s);
...
Is this correct?` : "I need your contact information. What is your name?";
    ...
    const a = W() || {}, s = ge(n), A = { ...a, name: s.name || a.name, email: s.email || a.email, accessId: r || s.accessId || a.accessId };
    let d = "";
...
Would you like to submit this security incident report?`;
    ...
    if (i.userInput === "Submit Security Report") {
      const u = W() || {}, c = ge(n), l = { ...u, name: c.name || u.name, email: c.email || u.email, accessId: r || c.accessId || u.accessId }, f = { summary: l.summary || "", priority: l.priority || "", description: l.description || "", name: l.name || "", email: l.email || "", accessId: l.accessId || "" };
      try {
...
const ga = Ye(), au = ({ children: e }) => {
  ...
  }, []), O.createElement("div", { className: "qa-bot " + (i ? "embedded-qa-bot" : ""), ref: B, role: "region", "aria-label": "Ask ACCESS tool" }, O.createElement(Ii, null, O.createElement("main", { role: "main", "aria-label": "Chat interface" }, O.createElement(Xc, { ref: t, embedded: i, isBotLoggedIn: p, currentOpen: r }), O.createElement(ks, { key: `chatbot-${g}-${p}`, settings: D, flow: H, plugins: [() => js(F), qc(), () => Wc(N)] }), O.createElement("div", { "aria-live": "polite", "aria-label": "Bot response updates", className: "sr-only", id: "bot-live-region" }), O.createElement("div", { id: "chat-input-help", className: "sr-only" }, "Type your message and press Enter to send. Use arrow keys to navigate through response options. Press Enter or Space to select an option."), O.createElement("div", { id: "keyboard-help", className: "sr-only" }, "Available keyboard shortcuts: Arrow keys to navigate options, Enter or Space to select, Tab to move between interactive elements, Escape to close dialogs."))));
  var N, F;
