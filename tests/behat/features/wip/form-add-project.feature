...
Feature: add a test project via the form
  ...
  Scenario: Add a project for verify it is created
    ...
    When I fill in "Project Title" with "test-create-project-title-3"
    ...
    When I fill in "Phone" with "555-1212"
    ...
    When I fill in "Github Contributions Link" with "test github link"
    ...
    Then I should see "test-create-project-title-3"
