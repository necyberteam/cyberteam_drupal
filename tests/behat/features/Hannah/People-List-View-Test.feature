...
Feature: test people page list view w/ filters 
  ...
  Scenario: Unauthenticated user tests the people page
    ...
    When I fill in "Search by Name" with "Michael Jackson"
    And I wait 4 seconds
    Then I should see "There are currently no People"


  #Name comes up as a link
  #  When I fill in "Search by Name" with "cameron"
  #  And I wait 4 seconds 
  #  Then I should see "Hannah Cameron"

    When I fill in "Search by Name" with "Julie"
    And I wait 4 seconds
    Then I should see "Julie Ma"
    #And I should see "MGHPCC"
    # When I hover over the element "Filter by Program"

    #Then I should go to "Card view"
