...
Feature: test ACCESS Support Match Plus Page
  ...
  Scenario: Unauthenticated user tests the Match Plus Page Sample Engagement Section
    ...
    Then I should see "Run Markov Chain Monte Carlo (MCMC) in Parallel for Evolutionary Studyg"
    Then I should see "Texas Tech University"
    #When I click "+ More"
    ...
    Then I should see "Run Markov Chain Monte Carlo (MCMC) in Parallel for Evolutionary Study"
    When I click "Run Markov Chain Monte Carlo (MCMC) in Parallel for Evolutionary Study"
    Then I should be on "/node/422"
    Then I should see "Run Markov Chain Monte Carlo (MCMC) in Parallel for Evolutionary Study"
    Then I should see "Institution"
    Then I should see "Texas Tech University"
    Then I should see "Status"
    Then I should see "Recruiting"
    Then I should see "My ongoing project"
    #Then I should see "Student"
    #Then I should see "Mentor"
    #Then I should see "Tags"
    # testing tags on /node/412
    Then I should see "biology"
    Then I should see "parallelization"
