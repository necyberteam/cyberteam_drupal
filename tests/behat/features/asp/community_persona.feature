...
Feature: test ACCESS Support Community Persona
  ...
  Scenario: Unauthenticated user tests the Community Persona for user 200
    ...
    Then I should see "jecleweradilustaweuothaspebadreclitajothaslatremimeheclibovuphoswusarosichuvaswecapranihovadrewrofrispithotripopomucrurichespetospumacranoprivesesteslatarelogifrapuspuslurechewrugutiswubre nuwiuashi"
