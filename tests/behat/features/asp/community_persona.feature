...
Feature: test ACCESS Support Community Persona
  ...
  Scenario: Specific user tests their own Community Persona
    Given I am logged in as user "test_walnut_pie"
    ...
    Then I should see "Connected with researchers of common interests."
    Then I should see "DELTA"
    ...
    Then I should see "You currently have not been matched with any Engagements. Click below to find an Engagement."
