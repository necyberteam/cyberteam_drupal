...
Feature: verify content of dropdown submenus on the ACCESS Support Homepage
  ...
  Scenario: Unauthenticated user tests the Homepage
    ...
    Then menu "ACCESS Menu" (with id="access-additional-universal-menu-menu-link-contentc11952c3-0fdb-48d2-b25e-9e6226f1234b") should have links "About, Announcements, Contact, Events & Trainings, New, Outages, Resource Providers"
  ...
  Scenario: Unauthenticated user tests the Homepage
    ...
    When I am on the homepage
    And menu "My ACCESS" (with id="access-additional-universal-menu-menu-link-contenta116f3f8-0d73-431e-9d9f-3427c584d7cb") should have links "Allocations, Community Persona, Edit Profile, Publications, Share with ORCID, Logout"
