...
Feature: test ACCESS Support Pegasus Page
  ...
  Scenario: Unauthenticated user tests the Pegasus Page
    ...
    When I go to "https://support.access-ci.org/pegasus"
...
#TODO: Pegasus Video
    ...
    When I am on "https://support.access-ci.org/pegasus"
    When I follow "Workflow Submit Host"
    Then I should be on "https://cilogon.org/authorize?response_type=code&scope=openid%20email%20org.cilogon.userinfo&client_id=cilogon%3A%2Fclient_id%2F57662fc94d2fcfbae1faffc582a30714&state=q3CZYPa9c0jY67v1O32-9BFA2fM&redirect_uri=https%3A%2F%2Faccess.pegasus.isi.edu%2Foidc&nonce=rup6o_NcJvQoaRLkpaGcnFuFdXPgN1Ql4J4wRcKhrjw"
