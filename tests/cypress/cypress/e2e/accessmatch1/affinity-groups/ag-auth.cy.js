...
describe('Anonymous user visit the affinity-group page', () => {
  it('should find expected stuff', () => {
    ...
    cy.get('.js-flag-affinity-group-618')
      .find(':contains("Join")')
      .invoke('attr', 'href')
      .should('contain', '/flag/flag/affinity_group/618/full?destination=/affinity-groups');
    ...
    cy.get('.js-flag-affinity-group-618')
      .find(':contains("Leave")')
      .invoke('attr', 'href')
      .should('contain', '/flag/unflag/affinity_group/618/full?destination=/affinity-groups');
